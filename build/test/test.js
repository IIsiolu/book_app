...
describe('Testing the book endpoints:', function () {
  it('It should create a book', function (done) {
    ...
    _chai["default"].request(_app["default"]).post('/api/v1/books').set('Accept', 'application/json').send(book).end(function (err, res) {
  ...
  it('It should get all books', function (done) {
    _chai["default"].request(_app["default"]).get('/api/v1/books').set('Accept', 'application/json').end(function (err, res) {
  ...
  it('It should get a particular book', function (done) {
    ...
    _chai["default"].request(_app["default"]).get("/api/v1/books/".concat(bookId)).set('Accept', 'application/json').end(function (err, res) {
      expect(res.status).to.equal(200);
  ...
  it('It should update a book', function (done) {
    ...
    _chai["default"].request(_app["default"]).put("/api/v1/books/".concat(bookId)).set('Accept', 'application/json').send(updatedBook).end(function (err, res) {
      expect(res.status).to.equal(200);
  ...
  it('It should delete a book', function (done) {
    ...
    _chai["default"].request(_app["default"])["delete"]("/api/v1/books/".concat(bookId)).set('Accept', 'application/json').end(function (err, res) {
      expect(res.status).to.equal(200);
      expect(res.body.data).to.include({});
      done();
    });
